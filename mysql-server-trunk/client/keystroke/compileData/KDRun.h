...
KDRegStore newUserRegistration() {
  ...
  std::cout << "\nDetected new user registration. Please have the new user "
               "complete the following:\n";
  std::cout << "Please enter the following words in all lowercase without "
               "making any mistakes, and without using unneeded keystrokes.\n";
  std::cout << "This will register your keystroke dynamic biometrics. Errors "
               "will ask for a reentry.\n\n";
